---
description: Nimmt die Arbeit nach /handoff und /clear wieder auf: Brief lesen, gegen den Arbeitsbaum pruefen, weitermachen
...
macht beim ersten offenen Punkt weiter. Hintergrund:
...
`<AGENTENORDNER>/vorgehen/03-build.md` beim Plan-Abbau, `/loop` beim Nachschärfen. Der
Brief wird dabei **nicht** fortgeschrieben — er ist ein Schnappschuss. Wird der neue
