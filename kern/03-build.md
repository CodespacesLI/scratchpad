...
exakt diese Zeichenkette. Ein Wächter liest sie.
...
acht Angaben. Fehlt eine, läuft der Arbeiter ins Leere oder ins Uferlose:
...
Sind alle Tasks abgehakt oder begründet gestrichen: `Status: im-bau` → `Status: fertig`,
...
- Ein Task nach dem anderen, in der Reihenfolge der Wellen.
