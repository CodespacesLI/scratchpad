...
def test_neutral(wurzel):
    ...
    for rel in (".agents/vorgehen/01-brainstorm.md", ".agents/tasks/README.md",
                ".agents/INSTRUCTIONS.md", ".agents/references/referenzen.md",
                ".agents/vorgehen/referenzen-holen.md"):
        da(ziel, rel)
    for rel in (".agents/skills", ".claude", "AGENTS.md"):
        nicht_da(ziel, rel)
...
def test_codex(wurzel):
    ...
    for rel in (".agents/vorgehen/03-build.md", ".agents/tasks/README.md",
                ".agents/INSTRUCTIONS.md", ".agents/skills/grill-me/SKILL.md",
...
def test_claude(wurzel):
    ...
    for rel in (".claude/vorgehen/01-brainstorm.md", ".claude/commands/build.md",
                ...
                ".claude/tasks/README.md", ".claude/references/referenzen.md",
                ".claude/vorgehen/referenzen-holen.md"):
        da(ziel, rel)
...
def main():
    ...
    try:
        for test in (test_neutral, test_codex, test_claude, test_hook_migration,
                     test_interaktiv_und_fehler, test_hook_befehl, test_start):
            test(wurzel)
    finally:
