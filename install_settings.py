...
Eintraege des Harness in den Merge. Der Platzhalter <AGENTENORDNER> wird dabei
...
Idempotent: ein bereits vorhandener outputStyle bleibt unveraendert, ein bereits
