...
Welche Eintraege genutzt werden, entscheidest du beim Klaeren der Anforderungen: Der Brief
nennt pro schwierigem Problem den Slug von hier. Direkt danach, vor dem Plan, holst du genau
diese Eintraege: `/ref <slug>` in Claude, `Referenzen: <slug>` in Codex. Die Dateien landen per
