...
function Installiere-Kern([string]$Basis, [string]$Agentenordner) { Copy-Ordner kern (Join-Path $Basis 'vorgehen'); Copy-Datei vorlagen/tasks-README.md (Join-Path $Basis 'tasks/README.md'); Copy-Datei agent/AGENTS-block.md (Join-Path $Basis 'INSTRUCTIONS.md'); Copy-Datei uebung/referenzen.md (Join-Path $Basis 'references/referenzen.md'); Ersetze-Platzhalter $Basis $Agentenordner }
...
switch ($Modus) {
  ...
  'claude' {
    ...
    Copy-Datei vorlagen/tasks-README.md (Join-Path $Basis 'tasks/README.md'); Copy-Datei kern/antwortform.md (Join-Path $Basis 'output-styles/scratchpad-projektleiter.md'); Copy-Datei uebung/referenzen.md (Join-Path $Basis 'references/referenzen.md')
